...
if  __name__ == '__main__':
    ...
    parser.add_argument('--g_lr', type=float, default = .00005, metavar='LR',
                        help='learning rate (default: 0.00005)')
    parser.add_argument('--d_lr', type=float, default = .00005, metavar='LR',
                        help='learning rate (default: 0.00005)')
    ...
    parser.add_argument('--save_folder', type=str, default= 'tmp_images', metavar='N',
                        help='folder to save the temporary images.')
    ...
    model_root, model_name = 'model', 'cxr_gpWgan'
